export const SDD_ROUTING_ERROR_CODES = {
  ...
  INVALID_PROJECT_PROFILE: "INVALID_PROJECT_PROFILE",
  UNKNOWN_CAPABILITY: "UNKNOWN_CAPABILITY",
  NO_ELIGIBLE_LANE: "NO_ELIGIBLE_LANE",
  WRITE_POLICY_VIOLATION: "WRITE_POLICY_VIOLATION",
  CRITICAL_CODEX_POLICY_REQUIRED: "CRITICAL_CODEX_POLICY_REQUIRED",
} as const;
